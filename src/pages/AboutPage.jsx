...
const AboutPage = (props) => {
  const { newDateee} = props
  const [showAnswer, setShowAnswer] = useState(false);
  const 
  [show, setShow] = useState(false);
  const [showhida, setShowhide] = useState(false);
  const [showhide, setShowhida] = useState(false);
  const [showhidi, setShowhidi] = useState(false);
  const [showhido, setShowhido] = useState(false);
